...
public class GradeAnalyzerTest {
    ...
    @Test
    void calculateAverage_returnCorrectAverage_forTypicalScores(){
    ...
    @Test
    void calculateAverage_ignoresInvalidNegativeScores(){
        ArrayList<Integer> scores = new ArrayList<>(Arrays.asList(80, -1, 100));
